...
| Week | Milestone                                   | Link                                                                        |      
|------|---------------------------------------------|--------------------------------------------------------------|
| 1    | Github Account Created                      | https://github.com/coraliecharpie |
| 1    | Github Profile Page Updated                 | https://github.com/coraliecharpie/coraliecharpie |
| 1    | Commit and Push Change from Command Line    | https://github.com/coraliecharpie/ppchem/commit/3a0dea79c115f9846f0ba79d5baa16341cc319b9 |
| 1    | Create a New Branch                           | https://github.com/coraliecharpie/ppchem/tree/new-branch-name  |
| 1    | Create a conda environment                  | https://github.com/coraliecharpie/ppchem/blob/main/env.yml |
| 1    | Fork a Repo                                 | https://github.com/coraliecharpie/practical-programming-in-chemistry-milestones |
| 1    | (Optional) Make a Pull Request              | |
| 2    | (Optional) Review a Pull Request            | |
| 4    | Update `env.yml` via a Pull Request         | [https://github.com/coraliecharpie/practical-programming-in-chemistry-milestones/pull/`pull-request-number`](https://github.com/coraliecharpie/ppchem/pull/1) |
